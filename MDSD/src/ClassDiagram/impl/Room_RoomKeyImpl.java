...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Room Room Key</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ClassDiagram.impl.Room_RoomKeyImpl#getExpirationDate <em>Expiration Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Room_RoomKeyImpl extends MinimalEObjectImpl.Container implements Room_RoomKey {
	/**
	...
	protected EClass eStaticClass() {
		return ClassDiagramPackage.Literals.ROOM_ROOM_KEY;
	}
	...
	public void setExpirationDate(Date newExpirationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagramPackage.ROOM_ROOM_KEY__EXPIRATION_DATE, oldExpirationDate, expirationDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassDiagramPackage.ROOM_ROOM_KEY__EXPIRATION_DATE:
