 ...
 *   <li>{@link ClassDiagram.Hotel_Staff#getStafftype <em>Stafftype</em>}</li>
 * </ul>
 *
...
public interface Hotel_Staff extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Stafftype</b></em>' attribute.
	 * The literals are from the enumeration {@link ClassDiagram.StaffType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Stafftype</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Stafftype</em>' attribute.
	 * @see ClassDiagram.StaffType
	 * @see #setStafftype(StaffType)
	 * @see ClassDiagram.ClassDiagramPackage#getHotel_Staff_Stafftype()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ClassDiagram.Hotel_Staff#getStafftype <em>Stafftype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Stafftype</em>' attribute.
	 * @see ClassDiagram.StaffType
	 * @see #getStafftype()
	 * @generated
	 */
